...
static const u16 sPlayerIcon_GreenPal[] = INCBIN_U16("graphics/region_map/player_icon_green.gbapal");
...
static const u32 sPlayerIcon_Green[] = INCBIN_U32("graphics/region_map/player_icon_green.4bpp.lz");
