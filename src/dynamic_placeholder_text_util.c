...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_RED_VS_SEEKER_BIKE / 2]      = 0x00, // OBJ_EVENT_GFX_BLUE_NORMAL
    [OBJ_EVENT_GFX_BLUE_BIKE / 2]               = 0x00, // OBJ_EVENT_GFX_BLUE_SURF
    [OBJ_EVENT_GFX_BLUE_FIELD_MOVE / 2]         = 0x00, // OBJ_EVENT_GFX_BLUE_FISH
    [OBJ_EVENT_GFX_BLUE_VS_SEEKER / 2]          = 0x00, // OBJ_EVENT_GFX_BLUE_VS_SEEKER_BIKE
    [OBJ_EVENT_GFX_GREEN_NORMAL / 2]            = 0x11, // OBJ_EVENT_GFX_GREEN_BIKE
    [OBJ_EVENT_GFX_GREEN_SURF / 2]              = 0x11, // OBJ_EVENT_GFX_GREEN_FIELD_MOVE
    [OBJ_EVENT_GFX_GREEN_FISH / 2]              = 0x11, // OBJ_EVENT_GFX_GREEN_VS_SEEKER
    [OBJ_EVENT_GFX_GREEN_VS_SEEKER_BIKE / 2]    = 0x10, // OBJ_EVENT_GFX_BRENDAN_NORMAL
    [OBJ_EVENT_GFX_BRENDAN_BIKE / 2]            = 0x00, // OBJ_EVENT_GFX_BRENDAN_SURF
    [OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE / 2]      = 0x00, // OBJ_EVENT_GFX_BRENDAN_FISH
    [OBJ_EVENT_GFX_BRENDAN_VS_SEEKER / 2]       = 0x00, // OBJ_EVENT_GFX_BRENDAN_VS_SEEKER_BIKE
    [OBJ_EVENT_GFX_MAY_NORMAL / 2]              = 0x11, // OBJ_EVENT_GFX_MAY_BIKE
    [OBJ_EVENT_GFX_MAY_SURF / 2]                = 0x11, // OBJ_EVENT_GFX_MAY_FIELD_MOVE
    [OBJ_EVENT_GFX_MAY_FISH / 2]                = 0x11, // OBJ_EVENT_GFX_MAY_VS_SEEKER
    [OBJ_EVENT_GFX_MAY_VS_SEEKER_BIKE / 2]      = 0x10, // OBJ_EVENT_GFX_RS_UNUSED_PADDING
    [OBJ_EVENT_GFX_RS_UNUSED_BRENDAN / 2]       = 0x10, // OBJ_EVENT_GFX_RS_UNUSED_MAY
