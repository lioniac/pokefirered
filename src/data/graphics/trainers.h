...
const u8 gTrainerBackPic_Green[] = INCBIN_U8("graphics/trainers/back_pics/green_back_pic.4bpp");
...
const u32 gTrainerPalette_GreenBackPic[] = INCBIN_U32("graphics/trainers/palettes/green_back_pic.gbapal.lz");
