...
static const union AnimCmd sAnimCmd_Blue_1[] = {
    ANIMCMD_FRAME(1, 20),
    ANIMCMD_FRAME(2, 6),
    ANIMCMD_FRAME(3, 6),
    ANIMCMD_FRAME(4, 24),
...
static const union AnimCmd sAnimCmd_Green_1[] = {
    ANIMCMD_FRAME(1, 20),
    ANIMCMD_FRAME(2, 6),
    ANIMCMD_FRAME(3, 6),
    ANIMCMD_FRAME(4, 24),
...
const union AnimCmd *const sBackAnims_Blue[] = {
    sAnim_GeneralFrame0,
    sAnimCmd_Blue_1
};

const union AnimCmd *const sBackAnims_Green[] = {
    sAnim_GeneralFrame0,
    sAnimCmd_Green_1
};
