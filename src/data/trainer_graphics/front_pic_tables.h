...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(CHAMPION_RIVAL_RED, gTrainerFrontPic_ChampionRivalRed, 0x800),
    TRAINER_SPRITE(CHAMPION_RIVAL_BLUE, gTrainerFrontPic_ChampionRivalBlue, 0x800),
    ...
    TRAINER_SPRITE(PLAYER_RED, gTrainerFrontPic_Red, 0x800),
    TRAINER_SPRITE(PLAYER_GREEN, gTrainerFrontPic_Green, 0x800),
    ...
    TRAINER_SPRITE(PLAYER_BLUE, gTrainerFrontPic_Blue, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(PLAYER_RED, gTrainerPalette_Red),
    TRAINER_PAL(PLAYER_GREEN, gTrainerPalette_Green),
    ...
    TRAINER_PAL(PLAYER_BLUE, gTrainerPalette_Blue),
    TRAINER_PAL(CHAMPION_RIVAL_RED, gTrainerPalette_ChampionRivalRed),
    TRAINER_PAL(CHAMPION_RIVAL_BLUE, gTrainerPalette_ChampionRivalBlue),
};
