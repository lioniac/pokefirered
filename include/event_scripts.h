...
extern const u8 gNameChoice_Brendan[];
extern const u8 gNameChoice_May[];
extern const u8 gSeasonChoice_Spring[];
extern const u8 gSeasonChoice_Summer[];
extern const u8 gSeasonChoice_Autumn[];
extern const u8 gSeasonChoice_Winter[];
extern const u8 gSeasonChoice_Random[];
...
extern const u8 gOakText_AskPlayerCharacter[];
