...
extern const u8 gStartMenuText_Map[];
...
extern const u8 gStartMenuDesc_Map[];
...
extern const u8 gText_Spring[];
extern const u8 gText_Summer[];
extern const u8 gText_Autumn[];
extern const u8 gText_Winter[];
